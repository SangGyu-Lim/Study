...
bool HelloWorld::init()
{
	...
	CCMenuItemImage *pCloseItem = CCMenuItemImage::create(
		"app-store-button-blue.png",
		"app-store-button-blue-hover.png",
		this,
