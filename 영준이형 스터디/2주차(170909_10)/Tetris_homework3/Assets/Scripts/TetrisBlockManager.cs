...
#region SingleTon
    ...
    void SpwanCurrentBlock()
    {
        ...
        currentBlock.transform.localPosition = new Vector3(CommonDefine.MOVE_BACKGROUND_POSITION_X,
            ((CommonDefine.MAX_BACKGROUND_HEIGHT / 2) - CommonDefine.BLOCK_START_Y_POSITION) * CommonDefine.BLOCK_SIZE, 0f);
    }
    ...
    TetrisBlock CreateBlock(BLOCK_TYPE type, int x, int y)
    {
        ...
        block.transform.localPosition = new Vector3(x * CommonDefine.BLOCK_SIZE - CommonDefine.MAX_BACKGROUND_WIDTH / 2 * CommonDefine.BLOCK_SIZE + CommonDefine.MOVE_BACKGROUND_POSITION_X,
